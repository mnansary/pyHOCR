...
'''
From:-- https://github.com/titu1994/DenseNet/blob/master/densenet_fast.py
...
def transition_block(ip, nb_filter, dropout_rate=None, weight_decay=1E-4):
    ...
    x = BatchNormalization(mode=0, axis=concat_axis, gamma_regularizer=l2(weight_decay),beta_regularizer=l2(weight_decay))(x)
...
def create_dense_net(nb_classes, img_dim, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=16, dropout_rate=None,weight_decay=1E-4, verbose=True):
